...
import FinalMixLevel1 from "./campaign/FinalMixLevel1.jsx";
...
const FINAL_MIX_DEEP = ["campaign-final-mix-level-1", "campaign-final-mix-level-2", "campaign-final-mix-level-3", "campaign-final-mix-level-4", "campaign-final-mix-level-5"];
...
export default function AppShell() {
  ...
  const renderHomeScreen = () => {
    switch (homeSubScreen) {
      ...
      case "campaign-final-mix-level-1": return <FinalMixLevel1 onBack={() => setHomeSubScreen("campaign-final-mix")} lang={language} />;
