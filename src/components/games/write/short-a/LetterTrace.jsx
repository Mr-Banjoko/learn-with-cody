...
const LETTER_STROKES = {
  ...
  // ── e : horizontal midbar, then up and around counterclockwise ───────────
  e: [
    { points: [
      { x: 0.26, y: 0.48 }, { x: 0.40, y: 0.47 }, { x: 0.54, y: 0.47 },
      { x: 0.65, y: 0.47 }, { x: 0.65, y: 0.41 }, { x: 0.59, y: 0.31 },
      { x: 0.46, y: 0.28 }, { x: 0.33, y: 0.31 }, { x: 0.24, y: 0.41 },
      { x: 0.22, y: 0.50 }, { x: 0.25, y: 0.60 }, { x: 0.34, y: 0.67 },
      { x: 0.46, y: 0.69 }, { x: 0.58, y: 0.66 }, { x: 0.65, y: 0.59 },
    ] },
  ],
  ...
  o: [
    { points: [
      { x: 0.62, y: 0.49 }, { x: 0.60, y: 0.33 }, { x: 0.54, y: 0.29 },
      { x: 0.44, y: 0.27 }, { x: 0.34, y: 0.29 }, { x: 0.26, y: 0.36 },
      { x: 0.22, y: 0.46 }, { x: 0.22, y: 0.56 }, { x: 0.26, y: 0.64 },
      { x: 0.34, y: 0.70 }, { x: 0.44, y: 0.72 }, { x: 0.54, y: 0.70 },
      { x: 0.62, y: 0.64 }, { x: 0.67, y: 0.56 }, { x: 0.69, y: 0.46 },
      { x: 0.67, y: 0.36 }, { x: 0.62, y: 0.49 },
    ] },
  ],
