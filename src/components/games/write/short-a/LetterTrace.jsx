...
const LETTER_STROKES = {
  ...
  s: [
    { points: [
      { x: 0.63, y: 0.32 }, { x: 0.54, y: 0.28 }, { x: 0.44, y: 0.28 },
      { x: 0.34, y: 0.31 }, { x: 0.28, y: 0.37 }, { x: 0.31, y: 0.44 },
      { x: 0.42, y: 0.48 }, { x: 0.54, y: 0.50 }, { x: 0.62, y: 0.54 },
      { x: 0.60, y: 0.62 }, { x: 0.50, y: 0.68 }, { x: 0.38, y: 0.68 },
      { x: 0.27, y: 0.64 },
    ] },
  ],
  ...
  // ── u : single stroke — down, curve, up, down to baseline ────────────────
  u: [
    { points: [
