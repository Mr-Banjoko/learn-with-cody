/**
 * CVCChampionLevel58 — "Learn Pack 15" (final-mix-level-058)
 * 8 rounds: phonics flashcard intro for each Pack 15 word.
 */
...
const WORD_ORDER = ["jog", "jig", "jug", "jam", "jab", "jet", "jot", "jar"];
...
export default function CVCChampionLevel58({ onBack, lang = "en" }) {
