/**
 * CVCChampionLevel30 — "Learn Pack 8" (final-mix-level-030)
 * 8 rounds: phonics flashcard intro for each Pack 8 word.
 */
...
const WORD_ORDER = ["log", "leg", "lid", "lad", "lab", "lip", "pal", "pug"];
...
export default function CVCChampionLevel30({ onBack, lang = "en" }) {
