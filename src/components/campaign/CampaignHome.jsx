...
const VOWEL_FOLDERS = [
  { id: "short-a", vowel: "a", label: "Short a", labelZh: "短元音 a", color: "#FF6B6B", emoji: "🍎", available: true,  levels: 41 },
  { id: "short-o", vowel: "o", label: "Short o", labelZh: "短元音 o", color: "#FF9F43", emoji: "🐙", available: true,  levels: 20 },
  ...
  { id: "cvc-champion", vowel: "★", label: "CVC Champion", labelZh: "CVC 冠军", color: "#4ECDC4", emoji: "🏆", available: true, levels: 88 },
];
