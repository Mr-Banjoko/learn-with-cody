/**
 * Level 6 — Introduce Batch B (first 3 words)
 * R1: phonics — can
 * R2: drag    — can
 * R3: phonics — pan
 * R4: drag    — pan
...
const ROUNDS = [
  { type: "phonics", card: findWord("can") },
  { type: "drag",    card: findWord("can") },
  { type: "phonics", card: findWord("pan") },
  { type: "drag",    card: findWord("pan") },
  { type: "phonics", card: findWord("jam") },
  { type: "drag",    card: findWord("jam") },
];
