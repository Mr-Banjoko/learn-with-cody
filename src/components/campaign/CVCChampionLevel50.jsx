/**
 * CVCChampionLevel50 — "Learn Pack 13" (final-mix-level-050)
 * 8 rounds: phonics flashcard intro for each Pack 13 word.
 */
...
const WORD_ORDER = ["wet", "wed", "wax", "wig", "win", "vet", "ran", "ram"];
...
export default function CVCChampionLevel50({ onBack, lang = "en" }) {
