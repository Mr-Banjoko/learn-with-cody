/**
 * ShortULevel11 — Learn Batch F: sub, bud, mud
 * R1: phonics — sub
 * R2: drag_v2 — sub
 * R3: phonics — bud
 * R4: drag_v2 — bud
...
const ROUND_SEQUENCE = [
  { type: "phonics", word: "sub" },
  { type: "drag",    word: "sub" },
  { type: "phonics", word: "bud" },
  { type: "drag",    word: "bud" },
  { type: "phonics", word: "mud" },
  { type: "drag",    word: "mud" },
];
...
export default function ShortULevel11({ onBack, lang = "en" }) {
