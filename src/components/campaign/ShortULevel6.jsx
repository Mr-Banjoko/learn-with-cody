/**
 * ShortULevel6 — Review Batch C
 * R1: missing01 — bun — vowel (u) pos 1
 * R2: letter_to_sound — u (via bun)
 * R3: dictation — fun
 * R4: rearrange_easy — pug
 * R5: word_to_audio — bun / bat / bit  (short-a/i contrast)
 */
...
const ROUND_SEQUENCE = [
  { type: "missing01",       word: "bun", missingPos: 1 },
  { type: "letter_to_sound", word: "bun" },
  { type: "dictation",       word: "fun" },
  { type: "rearrange_easy",  word: "pug" },
  { type: "word_to_audio",   words: ["bun", "bat", "bit"] },
];
...
export default function ShortULevel6({ onBack, lang = "en" }) {
  ...
  const rearrangeEasyData = useMemo(() => roundDef.type === "rearrange_easy" ? [buildShortUSliceData(roundDef.word)] : null, [roundIndex]); // eslint-disable-line
