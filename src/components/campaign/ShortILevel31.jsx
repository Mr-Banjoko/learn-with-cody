 ...
 * R5: word_match — hid — distractors: had, hod, hud
 * R6: catch — mix — x (final)
 * R7: identifying — lip
 * R8: writev2 — pin
 * R9: drag — kid
 */
...
const ROUND_SEQUENCE = [
  ...
  { type: "drawline" },
  { type: "word_match",    word: "hid", distractors: ["had", "hod", "hud"] },
...
export default function ShortILevel31({ onBack, lang = "en" }) {
