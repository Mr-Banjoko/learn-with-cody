/**
 * CVCChampionLevel62 — "Learn Pack 16" (final-mix-level-062)
 * 8 rounds: phonics flashcard intro for each Pack 16 word.
 */
...
const WORD_ORDER = ["rug", "rub", "rib", "rip", "rag", "ram", "rim", "rob"];
...
export default function CVCChampionLevel62({ onBack, lang = "en" }) {
