/**
 * CVCChampionLevel54 — "Learn Pack 14" (final-mix-level-054)
 * 8 rounds: phonics flashcard intro for each Pack 14 word.
 */
...
const WORD_ORDER = ["fox", "fix", "six", "box", "bog", "bug", "bus", "gas"];
...
export default function CVCChampionLevel54({ onBack, lang = "en" }) {
