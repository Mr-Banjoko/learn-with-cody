/**
 * CVCChampionLevel20 — "Pack 5 Intensive Practice" (final-mix-level-020)
 * R1: dictation      — tip
 * R2: word_match     — tap [tap, tep, tip, top, tup]
 * R3: writev2        — tug
 * R4: rearrange_easy — tag
 * R5: missing01      — top (middle, missing "o", choices o/a/i/e)
 * R6: drag_v2        — ten (vowel distractor "i")
 * R7: catch          — tan (missing letter "a", distractors e/i/o/u)
 */
...
export default function CVCChampionLevel20({ onBack, lang = "en" }) {
