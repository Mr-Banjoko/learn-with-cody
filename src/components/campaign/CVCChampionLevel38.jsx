/**
 * CVCChampionLevel38 — "Learn Pack 10" (final-mix-level-038)
 * 8 rounds: phonics flashcard intro for each Pack 10 word.
 */
...
const WORD_ORDER = ["sun", "sum", "sad", "sat", "sit", "sip", "sob", "sub"];
...
export default function CVCChampionLevel38({ onBack, lang = "en" }) {
