/**
 * CVCChampionLevel42 — "Learn Pack 11" (final-mix-level-042)
 * 8 rounds: phonics flashcard intro for each Pack 11 word.
 */
...
const WORD_ORDER = ["net", "nut", "not", "nap", "nab", "bin", "bun", "ban"];
...
export default function CVCChampionLevel42({ onBack, lang = "en" }) {
