...
const ROUNDS = [
  { type: "phonics", card: findWord("pen") },
  { type: "drag",    card: findWord("pen") },
  { type: "phonics", card: findWord("fed") },
  { type: "drag",    card: findWord("fed") },
  { type: "phonics", card: findWord("leg") },
  { type: "drag",    card: findWord("leg") },
];
...
export default function ShortELevel6({ onBack, lang = "en" }) {
