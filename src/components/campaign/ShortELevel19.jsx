 ...
 * R1: word_to_audio — pen  | pen, pan, ten   [audio guide]
 * R2: word_to_audio — bed  | bed, bad, red
 * R3: word_to_audio — men  | men, man, hen
 * R4: word_to_audio — fed  | fed, fad, bed
 * R5: word_to_audio — gem  | gem, jam, hem
 */
...
// First word in each array is the target
const ROUND_DEFS = [
  ["pen", "pan", "ten"],
  ["bed", "bad", "red"],
  ["men", "man", "hen"],
...
export default function ShortELevel19({ onBack, lang = "en" }) {
  ...
  const hintUrl = roundIndex === 0 ? `${GH}/word%20match/${lang === "zh" ? "chinese" : "english"}/hint.mp3` : null;
