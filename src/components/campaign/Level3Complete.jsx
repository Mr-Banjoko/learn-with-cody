/**
 * Level 3 completion/celebration screen with confetti.
 */
import { useEffect } from "react";
import { motion } from "framer-motion";
import confetti from "canvas-confetti";

export default function Level3Complete({ onBack, lang = "en" }) {
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      >
        {lang === "zh" ? "第 3 关完成！你是超级明星！🌟" : "Level 3 Complete! You're a superstar! 🌟"}
      </motion.p>
