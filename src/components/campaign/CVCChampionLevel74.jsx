/**
 * CVCChampionLevel74 — "Learn Pack 19" (final-mix-level-074)
 * 8 rounds: phonics flashcard intro for each Pack 19 word.
 */
...
const WORD_ORDER = ["hen", "hem", "ham", "hog", "hug", "tug", "tax", "sap"];
...
export default function CVCChampionLevel74({ onBack, lang = "en" }) {
