/**
 * CVCChampionLevel14 — "Learn Pack 4" (final-mix-level-014)
 * 8 rounds: phonics flashcard intro for each Pack 4 word.
 */
...
const WORD_ORDER = ["fan", "fun", "fin", "fit", "rat", "rod", "rid", "red"];
...
export default function CVCChampionLevel14({ onBack, lang = "en" }) {
