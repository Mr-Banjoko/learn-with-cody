/**
 * CVCChampionLevel34 — "Learn Pack 9" (final-mix-level-034)
 * 8 rounds: phonics flashcard intro for each Pack 9 word.
 */
...
const WORD_ORDER = ["mad", "mud", "dim", "dam", "den", "dip", "dab", "bud"];
...
export default function CVCChampionLevel34({ onBack, lang = "en" }) {
