/**
 * CVCChampionLevel70 — "Learn Pack 18" (final-mix-level-070)
 * 8 rounds: phonics flashcard intro for each Pack 18 word.
 */
...
const WORD_ORDER = ["fed", "bed", "bet", "bit", "bib", "fit", "fin", "fan"];
...
export default function CVCChampionLevel70({ onBack, lang = "en" }) {
