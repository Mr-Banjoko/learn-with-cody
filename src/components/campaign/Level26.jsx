/**
 * Level 26 — Introduce Batch F (first 3 words)
 * R1: phonics — cab
 * R2: drag    — cab
 * R3: phonics — lad
 * R4: drag    — lad
...
const ROUNDS = [
  { type: "phonics", card: findWord("cab") },
  { type: "drag",    card: findWord("cab") },
  { type: "phonics", card: findWord("lad") },
  { type: "drag",    card: findWord("lad") },
  { type: "phonics", card: findWord("lab") },
  { type: "drag",    card: findWord("lab") },
];
