/**
 * CVCChampionLevel10 — "Learn Pack 3" (final-mix-level-010)
 * 8 rounds: phonics flashcard intro for each Pack 3 word.
 */
...
const WORD_ORDER = ["cab", "cub", "cob", "cod", "kid", "keg", "cup", "cop"];
...
export default function CVCChampionLevel10({ onBack, lang = "en" }) {
