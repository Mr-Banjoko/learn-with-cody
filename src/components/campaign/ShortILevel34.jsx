/**
 * ShortILevel34 — Intro Batch F Part 3 (rim, six, fin, zip)
 * R1: phonics — rim
 * R2: missing01 — rim — final (m) pos 2
 * R3: phonics — six
 * R4: missing01 — six — final (x) pos 2
 * R5: phonics — fin
 * R6: missing01 — fin — initial (f) pos 0
 * R7: phonics — zip
 * R8: missing01 — zip — medial (i) pos 1
 */
...
const ROUNDS = [
  { type: "phonics",   word: "rim" },
  { type: "missing01", word: "rim", missingPos: 2 },
  { type: "phonics",   word: "six" },
  { type: "missing01", word: "six", missingPos: 2 },
  { type: "phonics",   word: "fin" },
  { type: "missing01", word: "fin", missingPos: 0 },
  { type: "phonics",   word: "zip" },
  { type: "missing01", word: "zip", missingPos: 1 },
];
...
export default function ShortILevel34({ onBack, lang = "en" }) {
