/**
 * ShortULevel7 — Learn Batch D: gun, sun, cup
 * R1: phonics — gun
 * R2: drag_v2 — gun
 * R3: phonics — sun
 * R4: drag_v2 — sun
...
const ROUND_SEQUENCE = [
  { type: "phonics", word: "gun" },
  { type: "drag",    word: "gun" },
  { type: "phonics", word: "sun" },
  { type: "drag",    word: "sun" },
  { type: "phonics", word: "cup" },
  { type: "drag",    word: "cup" },
];
...
export default function ShortULevel7({ onBack, lang = "en" }) {
