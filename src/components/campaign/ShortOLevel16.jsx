/**
 * ShortOLevel16 — Intro Batch E
 * R1-R10: phonics/connection pairs for hog, fog, cob, cog, jot
 */
...
const ROUNDS = [
  { type: "phonics",    word: "hog" },
  { type: "connection", word: "hog" },
  { type: "phonics",    word: "fog" },
  { type: "connection", word: "fog" },
  { type: "phonics",    word: "cob" },
  { type: "connection", word: "cob" },
  { type: "phonics",    word: "cog" },
  { type: "connection", word: "cog" },
  { type: "phonics",    word: "jot" },
  { type: "connection", word: "jot" },
];
...
export default function ShortOLevel16({ onBack, lang = "en" }) {
