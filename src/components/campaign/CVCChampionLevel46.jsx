/**
 * CVCChampionLevel46 — "Learn Pack 12" (final-mix-level-046)
 * 8 rounds: phonics flashcard intro for each Pack 12 word.
 */
...
const WORD_ORDER = ["met", "mat", "mop", "map", "mug", "men", "man", "mom"];
...
export default function CVCChampionLevel46({ onBack, lang = "en" }) {
