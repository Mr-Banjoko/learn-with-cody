/**
 * CVCChampionLevel6 — "Learn Pack 2" (final-mix-level-006)
 * 8 rounds: phonics flashcard intro for each Pack 2 word.
 */
...
const WORD_ORDER = ["pin", "pen", "pan", "pig", "peg", "pet", "pat", "pop"];
...
export default function CVCChampionLevel6({ onBack, lang = "en" }) {
