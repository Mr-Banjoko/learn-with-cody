/**
 * ShortULevel9 — Learn Batch E: pup, cub, rub
 * R1: phonics — pup
 * R2: drag_v2 — pup
 * R3: phonics — cub
 * R4: drag_v2 — cub
...
const ROUND_SEQUENCE = [
  { type: "phonics", word: "pup" },
  { type: "drag",    word: "pup" },
  { type: "phonics", word: "cub" },
  { type: "drag",    word: "cub" },
  { type: "phonics", word: "rub" },
  { type: "drag",    word: "rub" },
];
...
export default function ShortULevel9({ onBack, lang = "en" }) {
