/**
 * ShortULevel13 — Learn Batch G: bus, gum, sum
 * R1: phonics — bus
 * R2: drag_v2 — bus
 * R3: phonics — gum
 * R4: drag_v2 — gum
...
const ROUND_SEQUENCE = [
  { type: "phonics", word: "bus" },
  { type: "drag",    word: "bus" },
  { type: "phonics", word: "gum" },
  { type: "drag",    word: "gum" },
  { type: "phonics", word: "sum" },
  { type: "drag",    word: "sum" },
];
...
export default function ShortULevel13({ onBack, lang = "en" }) {
