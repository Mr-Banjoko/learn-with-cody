/**
 * Level 16 — Introduce Batch D (first 3 words)
 * R1: phonics — gas
 * R2: drag    — gas
 * R3: phonics — jar
 * R4: drag    — jar
...
const ROUNDS = [
  { type: "phonics", card: findWord("gas") },
  { type: "drag",    card: findWord("gas") },
  { type: "phonics", card: findWord("jar") },
  { type: "drag",    card: findWord("jar") },
  { type: "phonics", card: findWord("tag") },
  { type: "drag",    card: findWord("tag") },
];
