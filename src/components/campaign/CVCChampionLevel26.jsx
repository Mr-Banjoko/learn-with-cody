/**
 * CVCChampionLevel26 — "Learn Pack 7" (final-mix-level-026)
 * 8 rounds: phonics flashcard intro for each Pack 7 word.
 */
...
const WORD_ORDER = ["hot", "hut", "hat", "hit", "hem", "ham", "hop", "hip"];
...
export default function CVCChampionLevel26({ onBack, lang = "en" }) {
