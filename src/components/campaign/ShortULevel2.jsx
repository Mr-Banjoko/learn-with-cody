/**
 * ShortULevel2 — Review Batch A
 * R1: missing01 — bug — vowel (u) pos 1
 * R2: identifying — mug
 * R3: letter_to_sound — u (via bug)
 * R4: word_match — rug — distractors: rag, rig, rog
 * R5: missing01 — rug — final (g) pos 2
 */
...
const ROUND_SEQUENCE = [
  { type: "missing01",       word: "bug", missingPos: 1 },
  { type: "identifying",     word: "mug" },
  { type: "letter_to_sound", word: "bug" },
  { type: "word_match",      word: "rug", distractors: ["rag", "rig", "rog"] },
  { type: "missing01",       word: "rug", missingPos: 2 },
];
...
export default function ShortULevel2({ onBack, lang = "en" }) {
