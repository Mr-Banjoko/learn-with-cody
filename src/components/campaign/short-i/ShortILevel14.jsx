...
function buildDrawLineRound(def) {
  ...
  // Shuffled token order: t(tin), f(fin), p(pin) — no token sits below its own word
...
const ROUNDS = [
  { type: "drawline" },
  { type: "missing01",    card: findWord("rid"), missingPos: 1 }, // I MEDIAL
  { type: "rearrange_easy", word: "fin" },
  { type: "connection",   word: "fit" },
];
...
export default function ShortILevel14({ onBack, lang = "en" }) {
