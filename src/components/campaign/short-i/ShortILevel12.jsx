/**
 * Short I — Level 12 — Batch C Continued
 * R1: rearrange_easy — sip
 * R2: identifying    — zip
 * R3: catch          — hid | D (FINAL)
 * R4: connection     — hid
 */
...
const ROUNDS = [
  { type: "rearrange_easy", word: "sip" },
  { type: "identifying",    word: "zip" },
  { type: "catch",          word: "hid", missingLetter: "d" }, // D FINAL
  { type: "connection",     word: "hid" },
];
