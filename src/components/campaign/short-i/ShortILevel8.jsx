/**
 * Short I — Level 8 — Mixed Reinforcement
 * R1: missing01    — pig | I (MEDIAL)
 * R2: connection   — lip
 * R3: rearrange_easy — hip
 * R4: catch        — tin | T (INITIAL)
 */
...
const ROUNDS = [
  { type: "missing01",    card: findWord("pig"), missingPos: 1 }, // I MEDIAL
  { type: "connection",   word: "lip" },
  { type: "rearrange_easy", word: "hip" },
  { type: "catch",        word: "tin", missingLetter: "t" }, // T INITIAL
];
