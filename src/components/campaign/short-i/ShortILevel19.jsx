/**
 * Short I — Level 19 — Dictation Intro
 * R1: dictation — sit  [audio guide]
 * R2: dictation — pin
 * R3: writev2   — lip
 * R4: writev2   — sip
 */
...
const ROUNDS = [
  { type: "dictation", word: "sit" },
  { type: "dictation", word: "pin" },
  { type: "writev2",   word: "lip" },
  { type: "writev2",   word: "sip" },
];
...
export default function ShortILevel19({ onBack, lang = "en" }) {
  ...
  // R1 (index 0): dictation first appearance in Short I
