/**
 * Short I — Level 20 — Audio + Arcade Mix
 * R1: word_to_audio — bit | bit, bat, bet
 * R2: rearrange_easy — six
 * R3: identifying    — fig
 * R4: drag           — wig
 */
...
const ROUNDS = [
  { type: "word_to_audio", words: ["bit", "bat", "bet"] },
  { type: "rearrange_easy", word: "six" },
  { type: "identifying",    word: "fig" },
  { type: "drag",           card: findWord("wig") },
];
