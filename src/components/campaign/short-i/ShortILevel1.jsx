/**
 * Short I — Level 1 — Intro Batch A (Hook)
 * R1: phonics — sit  [audio guide]
 * R2: drag    — sit  [audio guide]
 * R3: phonics — pin
 * R4: drag    — pin
 */
...
const ROUNDS = [
  { type: "phonics", card: findWord("sit"), guided: true },
  { type: "drag",    card: findWord("sit") },
  { type: "phonics", card: findWord("pin") },
...
export default function ShortILevel1({ onBack, lang = "en" }) {
  ...
  // R2 (index 1): drag hint audio guide
  const hintUrl = roundIndex === 1
    ? `${GH}/letter_drag_hint/${lang === "zh" ? "chinese" : "english"}/hint%203.mp3`
    : null;
