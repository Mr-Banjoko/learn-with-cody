/**
 * Short I — Level 24 — Spelling Sprint
 * R1: dictation  — six
 * R2: writev2    — zip
 * R3: catch      — fig | F (INITIAL)
 * R4: identifying — wig
 */
...
const ROUNDS = [
  { type: "dictation",   word: "six" },
  { type: "writev2",     word: "zip" },
  { type: "catch",       word: "fig", missingLetter: "f" }, // F INITIAL
  { type: "identifying", word: "wig" },
];
