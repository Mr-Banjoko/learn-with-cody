...
// ── Identifying round (same logic as Level 4) ─────────────────────────────────
          ...
          return (
            <motion.button
              ...
              style={{
                ...
                boxShadow: isSelected ? `0 8px 28px ${colorSet.shadow}, 0 0 0 5px ${colorSet.ring}` : "0 4px 18px rgba(30,58,95,0.09)",
