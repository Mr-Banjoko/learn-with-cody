/**
 * ShortULevel19 — Build and Spell Mastery
 * R1: drag — tug
 * R2: rearrange_hard — mug
 * R3: writev2 — bus
 * R4: writev2 — sun
 * R5: catch — cup — c (initial)
 */
...
const ROUND_SEQUENCE = [
  { type: "drag",           word: "tug" },
  { type: "rearrange_hard", words: ["mug"] },
  { type: "writev2",        word: "bus" },
  { type: "writev2",        word: "sun" },
  { type: "catch",          word: "cup", missingLetter: "c" },
];
...
export default function ShortULevel19({ onBack, lang = "en" }) {
