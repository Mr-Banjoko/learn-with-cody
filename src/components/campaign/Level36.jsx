/**
 * Level 36 — Introduce Batch H (first 3 words)
 * R1: phonics — rag
 * R2: drag    — rag
 * R3: phonics — ram
 * R4: drag    — ram
...
const ROUNDS = [
  { type: "phonics", card: findWord("rag") },
  { type: "drag",    card: findWord("rag") },
  { type: "phonics", card: findWord("ram") },
  { type: "drag",    card: findWord("ram") },
  { type: "phonics", card: findWord("ran") },
  { type: "drag",    card: findWord("ran") },
];
