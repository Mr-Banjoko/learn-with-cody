/**
 * Level 17 — Finish Batch D + light review
 * R1: phonics   — tap
 * R2: drag      — tap
 * R3: phonics   — bag
 * R4: drag      — bag
 * R5: missing01 — gas | G (INITIAL, pos 0)
 * R6: missing01 — jar | R (FINAL, pos 2)
 */
...
const ROUNDS = [
  { type: "phonics",   card: findWord("tap") },
  { type: "drag",      card: findWord("tap") },
  { type: "phonics",   card: findWord("bag") },
  { type: "drag",      card: findWord("bag") },
  { type: "missing01", card: findWord("gas"), missingPos: 0 }, // G INITIAL
  { type: "missing01", card: findWord("jar"), missingPos: 2 }, // R FINAL
];
