/**
 * ShortILevel5 — Intro Batch B (fig, fit, fix)
 * R1: phonics — fig
 * R2: missing01 — fig — initial (f) pos 0
 * R3: phonics — fit
 * R4: missing01 — fit — final (t) pos 2
 * R5: phonics — fix
 * R6: missing01 — fix — final (x) pos 2
 */
...
const ROUNDS = [
  { type: "phonics",   word: "fig" },
  { type: "missing01", word: "fig", missingPos: 0 },
  { type: "phonics",   word: "fit" },
  { type: "missing01", word: "fit", missingPos: 2 },
  { type: "phonics",   word: "fix" },
  { type: "missing01", word: "fix", missingPos: 2 },
];
