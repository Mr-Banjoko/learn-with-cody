/**
 * CVCChampionLevel2 — "Learn Pack 1" (final-mix-level-002)
 * 8 rounds: phonics flashcard intro for each Pack 1 word.
 */
...
const WORD_ORDER = ["cat", "cot", "sit", "bat", "pot", "hit", "mat", "mop"];
...
export default function CVCChampionLevel2({ onBack, lang = "en" }) {
