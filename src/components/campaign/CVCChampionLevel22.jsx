/**
 * CVCChampionLevel22 — "Learn Pack 6" (final-mix-level-022)
 * 8 rounds: phonics flashcard intro for each Pack 6 word.
 */
...
const WORD_ORDER = ["bug", "big", "beg", "bag", "bog", "dog", "dig", "dad"];
...
export default function CVCChampionLevel22({ onBack, lang = "en" }) {
