/**
 * ShortILevel22 — Intro Batch E continued (wig, win)
 * R1: phonics — wig
 * R2: missing01 — wig — final (g) pos 2
 * R3: phonics — win
 * R4: missing01 — win — initial (w) pos 0
 * R5: rearrange_hard — pig [pair: pig + pin]
 * R6: dictation — pin
 */
...
const ROUNDS = [
  { type: "phonics",        word: "wig" },
  { type: "missing01",      word: "wig", missingPos: 2 },
  { type: "phonics",        word: "win" },
  { type: "missing01",      word: "win", missingPos: 0 },
  { type: "rearrange_hard", words: ["pig", "pin"] },
  { type: "dictation",      word: "pin" },
];
