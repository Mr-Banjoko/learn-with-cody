/**
 * Level 15 — Review A–C
 * R1: rearrange_easy — bat
 * R2: catch          — jam  | J (INITIAL)
 * R3: connection     — pat
 * R4: identifying    — ham
 * R5: drag           — can
 * R6: missing01      — cat  | A (MEDIAL, pos 1)
 */
...
const ROUND_SEQUENCE = [
  { type: "rearrange_easy", word: "bat" },
  { type: "catch",          word: "jam", missingLetter: "j" }, // J INITIAL
  { type: "connection",     word: "pat" },
  { type: "identifying",    word: "ham" },
  { type: "drag",           word: "can" },
  { type: "missing01",      word: "cat", missingPos: 1 },      // A MEDIAL
];
