...
export default function Level5Complete({ onBack, lang = "en" }) {
  useEffect(() => {
    ...
    const t3 = setTimeout(burst, 2200);
    return () => { clearTimeout(t1); clearTimeout(t2); clearTimeout(t3); confetti.reset(); };
  }, []);
  ...
  return (
    <div style={{
      ...
      >
        {lang === "zh" ? "第 5 关完成！你是超级明星！🌟" : "Level 5 Complete! You're a superstar! 🌟"}
      </motion.p>
