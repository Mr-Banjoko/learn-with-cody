...
export default function ShortULevel20({ onBack, lang = "en" }) {
  ...
  const connectionCard = useMemo(() => roundDef.type === "connection" ? buildShortUSliceData(roundDef.word) : null, [roundIndex]); // eslint-disable-line
