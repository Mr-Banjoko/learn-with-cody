/**
 * ShortELevel18 — Grand Review I: All Batches A+B (cross-vowel)
 * R1: word_match — bed — distractors: bad, bid, bod
 * R2: catch — jet — j (initial)
 * R3: rearrange_hard — bet + get
 * R4: drawline — {bed, fed, red} initial: b, f, r
 * R5: dictation — pet
 * R6: drag — wet
 * R7: identifying — vet
 * R8: writev2 — met
...
function buildDrawLineRound() {
  ...
  const bottomLetters = [
    { letter: "r", topCardId: topCards[2].id, botIdx: 0 },
    { letter: "b", topCardId: topCards[0].id, botIdx: 1 },
    { letter: "f", topCardId: topCards[1].id, botIdx: 2 },
  ];
...
const ROUND_SEQUENCE = [
  ...
  { type: "catch",          word: "jet",  missingLetter: "j" },
  { type: "rearrange_hard", words: ["bet", "get"] },
  { type: "drawline" },
  { type: "dictation",      word: "pet" },
  { type: "drag",           word: "wet" },
...
export default function ShortELevel18({ onBack, lang = "en" }) {
