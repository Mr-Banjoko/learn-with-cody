/**
 * Level 32 — Finish Batch G + light review
 * R1: phonics   — man
 * R2: drag      — man
 * R3: phonics   — nab
 * R4: drag      — nab
 * R5: missing01 — dab | D (INITIAL, pos 0)
 * R6: missing01 — fan | A (MEDIAL, pos 1)
 */
...
const ROUNDS = [
  { type: "phonics",   card: findWord("man") },
  { type: "drag",      card: findWord("man") },
  { type: "phonics",   card: findWord("nab") },
  { type: "drag",      card: findWord("nab") },
  { type: "missing01", card: findWord("dab"), missingPos: 0 }, // D INITIAL
  { type: "missing01", card: findWord("fan"), missingPos: 1 }, // A MEDIAL
];
