/**
 * Level 3 — 7-round fixed sequence:
 *   Round 1: Missing Sound  — rat  (missing: r)
 *   Round 2: Missing Sound  — dad  (missing: a)
 *   Round 3: Drag the Letter — cat
 *   Round 4: Missing Sound  — hat  (missing: a)
 *   Round 5: Missing Sound  — bat  (missing: t)
 *   Round 6: Drag the Letter — bat
 *   Round 7: Drag the Letter — rat
 */
...
const ROUND_SEQUENCE = [
  ...
  { type: "drag",    word: "cat" },
  { type: "missing", word: "hat", missingLetter: "a", missingPos: 1 },
  { type: "missing", word: "bat", missingLetter: "t", missingPos: 2 },
  { type: "drag",    word: "bat" },
  { type: "drag",    word: "rat" },
];
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        display: "flex", gap: "min(20px, 4vw)", alignItems: "center", justifyContent: "center", flexShrink: 0,
      }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, flexShrink: 0 }}>
        <motion.button
          ...
          style={{
            ...
            display: "flex", alignItems: "center", justifyContent: "center",
            boxShadow: `0 6px 24px ${accentColor}55`, cursor: "pointer", touchAction: "manipulation",
          }}
        >
        ...
        {round.options.map((option) => {
          ...
          return (
            <motion.div
              ...
              style={{
                width: "min(74px, 19vw)", height: "min(74px, 19vw)", borderRadius: 20,
                background: "white", border: "2.5px solid rgba(168,208,230,0.55)",
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: "min(38px, 9.5vw)", fontWeight: 700, color: "#1E3A5F",
                boxShadow: "0 3px 12px rgba(30,58,95,0.08)",
                cursor: "grab", touchAction: "none", userSelect: "none",
                pointerEvents: isDraggingThis ? "none" : "auto", flexShrink: 0,
              }}
            >
              {option.letter}
            </motion.div>
      ...
      <AnimatePresence>
        {dragState && isActiveDrag && (
          <div style={{
            ...
            background: "white", border: "2.5px solid rgba(168,208,230,0.7)",
            display: "flex", alignItems: "center", justifyContent: "center",
...
export default function Level2({ onBack, lang = "en" }) {
  ...
  const hintUrl = getHintAudioUrl(2, roundIndex, lang);
