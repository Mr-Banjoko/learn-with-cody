/**
 * Level 14 — 5-round Identifying Game
 *
 * Round order:
 *  1. sad
 *  2. sat
 ...
 *  5. ham
 *
 * Reuses IdentifyingRound (same component used in Level4, Level5, Level9, Level10).
 */
import { useState, useMemo, useCallback } from "react";
import { motion, AnimatePresence } from "framer-motion";
import BackArrow from "../BackArrow";
import IdentifyingRound from "../games/IdentifyingRound";
import Level14Complete from "./Level14Complete";
...
export default function Level14({ onBack, lang = "en" }) {
      ...
      <AnimatePresence mode="wait">
        {done ? (
          <motion.div key="complete" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0 }} transition={{ duration: 0.3 }} style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
            <Level14Complete onBack={onBack} lang={lang} />
          </motion.div>
        ) : (
