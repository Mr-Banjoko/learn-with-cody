/**
 * ShortILevel35 — Intro Batch F Part 4 (jig, gig, bib)
 * R1: phonics — jig
 * R2: missing01 — jig — initial (j) pos 0
 * R3: phonics — gig
 * R4: missing01 — gig — medial (i) pos 1
 * R5: phonics — bib
 * R6: missing01 — bib — final (b) pos 2
 */
...
const ROUNDS = [
  { type: "phonics",   word: "jig" },
  { type: "missing01", word: "jig", missingPos: 0 },
  { type: "phonics",   word: "gig" },
  { type: "missing01", word: "gig", missingPos: 1 },
  { type: "phonics",   word: "bib" },
  { type: "missing01", word: "bib", missingPos: 2 },
];
...
export default function ShortILevel35({ onBack, lang = "en" }) {
