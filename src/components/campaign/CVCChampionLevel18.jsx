/**
 * CVCChampionLevel18 — "Learn Pack 5" (final-mix-level-018)
 * 8 rounds: phonics flashcard intro for each Pack 5 word.
 */
...
const WORD_ORDER = ["ten", "tin", "tan", "top", "tap", "tip", "tug", "tag"];
...
export default function CVCChampionLevel18({ onBack, lang = "en" }) {
