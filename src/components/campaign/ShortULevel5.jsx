/**
 * ShortULevel5 — Learn Batch C: pug, bun, fun
 * R1: phonics — pug
 * R2: drag_v2 — pug
 * R3: phonics — bun
 * R4: drag_v2 — bun
...
const ROUND_SEQUENCE = [
  { type: "phonics", word: "pug" },
  { type: "drag",    word: "pug" },
  { type: "phonics", word: "bun" },
  { type: "drag",    word: "bun" },
  { type: "phonics", word: "fun" },
  { type: "drag",    word: "fun" },
];
...
export default function ShortULevel5({ onBack, lang = "en" }) {
