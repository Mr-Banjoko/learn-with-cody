/**
 * Level 11 — Introduce Batch C (first 3 words)
 * R1: phonics — sad
 * R2: drag    — sad
 * R3: phonics — sat
 * R4: drag    — sat
...
const ROUNDS = [
  { type: "phonics", card: findWord("sad") },
  { type: "drag",    card: findWord("sad") },
  { type: "phonics", card: findWord("sat") },
  { type: "drag",    card: findWord("sat") },
  { type: "phonics", card: findWord("pat") },
  { type: "drag",    card: findWord("pat") },
];
