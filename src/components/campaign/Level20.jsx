...
const ROUND_SEQUENCE = [
  { type: "drawline" },
  { type: "connection",     word: "bag" },
  { type: "catch",          word: "sat", missingLetter: "a" }, // A MEDIAL
  { type: "identifying",    word: "tap" },
  { type: "rearrange_easy", word: "jar" },
  { type: "drag",           word: "hat" },
];
...
function buildDrawLineRound(def) {
  ...
  // Shuffled token order: n(can), t(hat), p(map) — no token sits below its own word
