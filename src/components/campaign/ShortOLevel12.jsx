/**
 * ShortOLevel12 — Intro Batch D
 * R1-R10: phonics/drag pairs for sob, cod, cop, cot, bog
 */
...
const ROUNDS = [
  { type: "phonics", word: "sob" },
  { type: "drag",    word: "sob" },
  { type: "phonics", word: "cod" },
  { type: "drag",    word: "cod" },
  { type: "phonics", word: "cop" },
  { type: "drag",    word: "cop" },
  { type: "phonics", word: "cot" },
  { type: "drag",    word: "cot" },
  { type: "phonics", word: "bog" },
  { type: "drag",    word: "bog" },
];
...
export default function ShortOLevel12({ onBack, lang = "en" }) {
