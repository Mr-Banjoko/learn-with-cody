/**
 * Level 7 — Finish Batch B + light review
 * R1: phonics   — map
 * R2: drag      — map
 * R3: phonics   — mat
 * R4: drag      — mat
 * R5: missing01 — can | N (FINAL, pos 2)
 * R6: missing01 — pan | P (INITIAL, pos 0)
 */
...
const ROUNDS = [
  { type: "phonics",  card: findWord("map") },
  { type: "drag",     card: findWord("map") },
  { type: "phonics",  card: findWord("mat") },
  { type: "drag",     card: findWord("mat") },
  { type: "missing01", card: findWord("can"), missingPos: 2 }, // N FINAL
  { type: "missing01", card: findWord("pan"), missingPos: 0 }, // P INITIAL
];
