/**
 * ShortULevel10 — Review Batch E
 * R1: missing01 — pup — vowel (u) pos 1
 * R2: word_match — cub — distractors: cab, cib, cob
 * R3: letter_to_sound — u (via cub)
 * R4: dictation — rub
 * R5: write — pup  (using WriteV2CampaignRound as the campaign write)
 */
...
const ROUND_SEQUENCE = [
  ...
  { type: "word_match",      word: "cub", distractors: ["cab", "cib", "cob"] },
  { type: "letter_to_sound", word: "cub" },
  { type: "dictation",       word: "rub" },
  { type: "writev2",         word: "pup" },
];
...
export default function ShortULevel10({ onBack, lang = "en" }) {
