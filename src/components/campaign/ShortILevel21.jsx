/**
 * ShortILevel21 — Intro Batch E (pig, pin, pit)
 * R1: phonics — pig
 * R2: missing01 — pig — initial (p) pos 0
 * R3: phonics — pin
 * R4: missing01 — pin — final (n) pos 2
 * R5: phonics — pit
 * R6: missing01 — pit — medial (i) pos 1
 */
...
const ROUNDS = [
  { type: "phonics",   word: "pig" },
  { type: "missing01", word: "pig", missingPos: 0 },
  { type: "phonics",   word: "pin" },
  { type: "missing01", word: "pin", missingPos: 2 },
  { type: "phonics",   word: "pit" },
  { type: "missing01", word: "pit", missingPos: 1 },
];
