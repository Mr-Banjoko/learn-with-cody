...
const ROUNDS = [
  { type: "phonics", card: findWord("bed") },
  { type: "drag",    card: findWord("bed") },
  { type: "phonics", card: findWord("bet") },
  { type: "drag",    card: findWord("bet") },
  { type: "phonics", card: findWord("met") },
