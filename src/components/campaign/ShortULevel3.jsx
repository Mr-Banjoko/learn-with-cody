/**
 * ShortULevel3 — Learn Batch B: hug, jug, tug
 * R1: phonics — hug
 * R2: drag_v2 — hug
 * R3: phonics — jug
 * R4: drag_v2 — jug
...
const ROUND_SEQUENCE = [
  { type: "phonics", word: "hug" },
  { type: "drag",    word: "hug" },
  { type: "phonics", word: "jug" },
  { type: "drag",    word: "jug" },
  { type: "phonics", word: "tug" },
  { type: "drag",    word: "tug" },
];
...
export default function ShortULevel3({ onBack, lang = "en" }) {
