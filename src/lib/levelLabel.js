...
const CVC_CHAMPION_LEARN  = new Set([1, 2, 6, 10, 14, 18, 22, 26, 30, 34, 38, 42, 46, 50, 54, 58, 62, 66, 70]);
const CVC_CHAMPION_REVIEW = new Set([5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45, 49, 53, 57, 61, 65, 69, 73]);
